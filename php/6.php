...
namespace Database;
// Define o namespace 'Database' para organizar o código e evitar conflitos de nomes

use PDO;
use PDOException;
// Importa as classes PDO e PDOException do PHP para manipulação de banco de dados e tratamento de exceções
...
// Chama o método getConnection para obter a conexão com o banco de dados e armazena na variável $connection
