...
class TarefaController
{
    ...
    public function editar()
    {
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            header('Location: C:\Turma2\xampp\htdocs\pos-ferias\php\9\View\tarefas\editar.php');
        }
    }
    ...
    public function deletar($id)
    {
        if ($_SERVER['REQUEST_METHOD'] === 'GET') {
            ...
            header('Location: C:\Turma2\xampp\htdocs\pos-ferias\php\9\View\tarefas\index.php');
        }
    }
}
